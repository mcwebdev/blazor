    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FailedCommands", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TaskLabels_Workspaces_WorkspaceId",
                        column: x => x.WorkspaceId,
                        principalTable: "Workspaces",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    BoardId = table.Column<Guid>(type: "TEXT", nullable: false),
                    ActivityLogSequenceNumber = table.Column<long>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TaskDependencies_TaskItems_BlockingTaskId",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    TaskItemId = table.Column<Guid>(type: "TEXT", nullable: false),
                    TaskLabelId = table.Column<Guid>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ActivityLogs_BoardId_SequenceNumber",
                table: "ActivityLogs",
                columns: new[] { "BoardId", "SequenceNumber" });

            migrationBuilder.CreateIndex(
                name: "IX_ActivityLogs_IdempotencyKey",
                table: "ActivityLogs",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FeatureFlags_WorkspaceId_Key",
                table: "FeatureFlags",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskItems_BoardId_ColumnId_SortOrder",
                table: "TaskItems",
                columns: new[] { "BoardId", "ColumnId", "SortOrder" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskLabels_WorkspaceId",
                table: "TaskLabels",
                column: "WorkspaceId");
